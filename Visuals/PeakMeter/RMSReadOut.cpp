...
/// </summary>
void rms_read_out_t::Initialize(state_t * state, const graph_description_t * settings, const analysis_t * analysis) noexcept
{
    _State = state;
...
/// </summary>
void rms_read_out_t::Render(ID2D1DeviceContext * deviceContext, const gauge_metrics_t & gaugeMetrics) noexcept
{
...
/// </summary>
void rms_read_out_t::RenderHorizontal(ID2D1DeviceContext * deviceContext, const gauge_metrics_t & gaugeMetrics) const noexcept
{
    D2D1_RECT_F Rect = { };
...
/// </summary>
void rms_read_out_t::RenderVertical(ID2D1DeviceContext * deviceContext, const gauge_metrics_t & gaugeMetrics) const noexcept
{
    D2D1_RECT_F Rect = { };
...
/// </summary>
HRESULT rms_read_out_t::CreateDeviceSpecificResources(ID2D1DeviceContext * deviceContext) noexcept
{
    HRESULT hr = S_OK;
    ...
    if (SUCCEEDED(hr))
        hr = _State->_StyleManager.GetInitializedStyle(VisualElement::GaugeRMSLevelText, deviceContext, Size, L"+199.9", 1.f, &_TextStyle);
