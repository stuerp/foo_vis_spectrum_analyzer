...
public:
    ...
    /// </summary>
    inline static COLORREF Blend(COLORREF c1, COLORREF c2, int factor) noexcept
    {
    ...
    /// </summary>
    inline static D2D1_COLOR_F ToD2D1_COLOR_F(COLORREF color) noexcept
    {
    ...
    /// </summary>
    inline static COLORREF ToCOLORREF(const D2D1_COLOR_F & color) noexcept
    {
    ...
    /// </summary>
    inline static HBRUSH CreateBrush(const D2D1_COLOR_F & color) noexcept
    {
