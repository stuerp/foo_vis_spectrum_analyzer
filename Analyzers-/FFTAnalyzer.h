...
public:
    ...
    /// </summary>
    FFTAnalyzer(uint32_t channelCount, uint32_t channelSetup, double sampleRate, const WindowFunction & windowFunction, const Configuration * configuration) : FFTProvider(channelCount, channelSetup, sampleRate, windowFunction, (size_t) configuration->_FFTSize)
    {
